...
internal class MoneroOutputComparer : Comparer<MoneroOutput>
{
    ...
    public override int Compare(MoneroOutput? o1, MoneroOutput? o2)
    {
        ...
        if (ow1 == null)
        {
            return -1; // nulls are less than non-nulls
        }

        if (ow2 == null)
        {
            return 1; // non-nulls are greater than nulls
        }
        ...
        if (ow1AccountIdx == null && ow2AccountIdx == null)
        {
            return 0; // both outputs have no account index
        }

        if (ow1AccountIdx == null)
        {
            return -1; // output 1 has no account index
        }

        if (ow2AccountIdx == null)
        {
            return 1; // output 2 has no account index
        }
        ...
        if (ow1SubaddressIdx == null && ow2SubaddressIdx == null)
        {
            return 0; // both outputs have no subaddress index
        }

        if (ow1SubaddressIdx == null)
        {
            return -1; // output 1 has no subaddress index
        }

        if (ow2SubaddressIdx == null)
        {
            return 1; // output 2 has no subaddress index
        }
        ...
        if (ow1Index == null && ow2Index == null)
        {
            return 0; // both outputs have no index
        }

        if (ow1Index == null)
        {
            return -1; // output 1 has no index
        }

        if (ow2Index == null)
        {
            return 1; // output 2 has no index
        }
        ...
        if (ow1KeyImage == null && ow2KeyImage == null)
        {
            return 0; // both outputs have no key image
        }

        if (ow1KeyImage == null)
        {
            return -1; // output 1 has no key image
        }
        ...
        {
            return 0; // both outputs have no key image hex
        }

        if (ow1KeyImageHex == null)
        {
            return -1; // output 1 has no key image hex
        }

        if (ow2KeyImageHex == null)
        {
