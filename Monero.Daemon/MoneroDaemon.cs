...
namespace Monero.Daemon
{
    public interface MoneroDaemon
    {
        ...
        public List<MoneroBlock> GetBlocksByRangeChunked(ulong startHeight, ulong endHeight);
        ...
        public MoneroMinerTxSum GetMinerTxSum(ulong height, ulong numBlocks);
        ...
        public List<MoneroOutputDistributionEntry> GetOutputDistribution(List<ulong> amounts, bool isCumulative, ulong startHeight, ulong endHeight);
